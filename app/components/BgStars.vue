...
<template>
	<!-- <div class="fixed pointer-events-none z-[-1] inset-0 w-screen h-screen overflow-hidden"></div> -->
	<!-- <div class="absolute pointer-events-none z-[-1] inset-y-0 inset-x-5 sm:inset-x-7 lg:inset-x-9 overflow-hidden"></div> -->
	<div class="fixed pointer-events-none z-[-1] inset-0 w-screen h-screen overflow-hidden">
		<svg
		...
		>
			...
			<defs>
				...
				>
					<stop stop-color="var(--ui-warning)" />
					<stop
						offset="1"
						stop-color="var(--ui-warning)"
						stop-opacity="0"
					/>
				</radialGradient>
				<linearGradient
